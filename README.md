...
## Project Information
* **Project Description:**
This project aims to analyze student data to address the challenge of understanding and predicting academic performance. Using multiple student-related attributes, the project applies classification techniques to categorize students into different academic performance groups based on their final grades.
